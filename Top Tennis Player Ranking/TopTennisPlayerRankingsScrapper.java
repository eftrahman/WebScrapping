...
public class TopTennisPlayerRankingsScraper {

    public static void main(String[] args) {
        List<TennisPlayer> players = new ArrayList<>();

        try {
            // Connect to the ATP top men's singles rankings page
            Document doc = Jsoup.connect("https://www.atptour.com/en/rankings/singles")
                                .timeout(6000).get();
            ...
            writePlayersToFile(players, "top_tennis_player_rankings.csv");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
